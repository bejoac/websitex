...
def set_descriptor_types_for_field(
    ...
    *,
    ...
    is_primary_key = helpers.get_bool_call_argument_by_name(
        ctx, "primary_key", default=False
    )
    ...
    if not (
        isinstance(mapped_types.set, UninhabitedType)
        or isinstance(mapped_types.get, UninhabitedType)
    ):
        ...
        get_type = get_proper_type(
            helpers.convert_any_to_type(mapped_types.get, get_type)
        )
...
def determine_type_of_array_field(
    ...
    base_field_arg_type = get_proper_type(
        helpers.get_call_argument_type_by_name(ctx, "base_field")
    )
    ...
    for new_type, default_arg in zip(
        base_field_arg_type.args, default_return_type.args, strict=False
    ):
