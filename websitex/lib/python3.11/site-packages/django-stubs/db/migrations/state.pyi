...
class ModelState:
    ...
    @classmethod
    def from_model(
        cls, model: type[Model], exclude_rels: bool = False
    ) -> ModelState: ...
...
class ProjectState:
    ...
    def reload_model(
        self, app_label: str, model_name: str, delay: bool = False
    ) -> None: ...
    ...
    def alter_constraint(
        self, app_label: str, model_name: str, constraint_name: str, constraint: Any
    ) -> None: ...
    def add_field(
        self,
        app_label: str,
    ...
    def resolve_model_field_relations(
        ...
        field_name: str,
        field: Field,
        concretes: Any | None = None,
    ) -> None: ...
    def resolve_model_relations(
        self, model_key: tuple[str, str], concretes: Any | None = None
    ) -> None: ...
